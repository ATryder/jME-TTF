...
/**
 * Loads a {@link TrueTypeMesh} from a .ttf file stored on disk.
 * 
 * @see TrueTypeKey
...
public class TrueTypeLoaderMesh implements AssetLoader {
    @Override
    public TrueTypeMesh load(AssetInfo assetInfo) throws IOException {
        TrueTypeKeyMesh key = (TrueTypeKeyMesh)assetInfo.getKey();
